...
**classroom; textbook; store; push; create; contents; index; host**
...
GitHub Pages **create** our websites, and in order to view a specific page, we need to include the entire file path to the URL, including all subdirectories.
